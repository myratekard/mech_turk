...
_SYSTEM = (
    ...
    "5) appears_african_descent: a best-effort, INFORMATIONAL guess of whether the profile owner "
    "appears to be of African descent (from the photo, name, bio, content); null if unclear. This "
    "is for analytics ONLY and must NOT influence is_verified or the verdict in any way.\n\n"
